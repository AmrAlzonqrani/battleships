...
describe('GameBoard instance', () => {
  ...
  describe('receiveAttack()', () => {
    test('marks specified square as hit for an empty square', () => {
    ...
    test("marks specified square as hit for occupied square, and calls the ship's hit method to increment its hit count", () => {
      board.placeShip(1, 1, 3);
